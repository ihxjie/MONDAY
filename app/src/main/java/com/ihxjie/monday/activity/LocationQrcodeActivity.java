...
public class LocationQrcodeActivity extends AppCompatActivity {

    private static final String TAG = "FaceLocationActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_location_qrcode);
        canAtt = false;

        Attendance attendance = (Attendance) getIntent().getSerializableExtra("attendance");
        positionInfo = new PositionInfo();

        button = findViewById(R.id.btn_face);
    ...
    private void submitAttGps(PositionInfo positionInfo){
        ...
        Call<String> call = recordService.faceGps(userId, positionInfo);
