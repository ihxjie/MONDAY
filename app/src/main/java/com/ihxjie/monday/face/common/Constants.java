package com.ihxjie.monday.face.common;

public class Constants {

    public static final String APP_ID = "Dfxcgf8r5UQ1gCPPeGCtYmUiQrCAQeXPDapFfXoLCjF8";
    public static final String SDK_KEY = "96afcPxH6YGEJ7rGUFENT358wLrGLNoUm4jwM7Uv3kcC";
